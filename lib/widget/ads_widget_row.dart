            ...
            child: IntrinsicHeight(
              ...
              crossAxisAlignment: CrossAxisAlignment.stretch,
                children: <Widget>[
                  Container(
                      ...
                      child: ClipRRect(
                        borderRadius:BorderRadius.circular(20) ,
                        child:
                          (widget.model.AdvertismentImages.isNotEmpty&&widget.model.AdvertismentImages[0].Url!=null&&widget.model.AdvertismentImages[0].Url.isNotEmpty)?
                ...
                CachedNetworkImage(
                          ...
                          imageUrl: APIConstants.getFullImageUrl(widget.model.AdvertismentImages.isEmpty?"":widget.model.AdvertismentImages[0].Url,ImageType.ADS),
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(widget.model.CityNameEnglish, style: Theme.of(context).textTheme.bodyText2),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                FittedBox(
                                  child: Text( displayTimeAgoFromTimestamp(widget.model.CreationTime),
                            ...
                            child: FavroiteWidget(
                                onFavChange:(val){
                                  ...
                                  if(BlocProvider.of<LoginBloc>(context).isLogged())
                                    BlocProvider.of<FavroiteBloc>(context).changeFavoriteState(val,widget.model.Id);
                                  else
                                    Navigator.push(
                                        context, MaterialPageRoute(builder: (context) => ParentAuthPage()));                          },
                                value:                   (BlocProvider.of<LoginBloc>(context).isLogged())?widget.model.IsFavorite:false
                            )
