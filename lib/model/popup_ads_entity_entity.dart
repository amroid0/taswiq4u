...
class PopupAdsEntityList {
  ...
  @JsonKey(name: "SystemDataFile") //SystemDataFile1
  ...
  PopupAdsEntityList(
      ...
      this.categoryId,
      this.category,
      this.systemDataFile1,
      this.instagramLink,
      this.phoneNumber,
      this.commercialAdsUsers,
      this.isLiked);
  factory PopupAdsEntityList.fromJson(Map<String, dynamic> json) =>
      _$PopupAdsEntityListFromJson(json);
}
...
class PopupAdsEntityListCategory {
  ...
  factory PopupAdsEntityListCategory.fromJson(Map<String, dynamic> json) =>
      _$PopupAdsEntityListCategoryFromJson(json);
}
...
class PopupAdsEntityListSystemDataFile {
  ...
  PopupAdsEntityListSystemDataFile(
      this.$id,
      this.id,
      this.url,
      this.size,
      ...
      this.isDeleted,
      this.isAssinged);
  factory PopupAdsEntityListSystemDataFile.fromJson(
          Map<String, dynamic> json) =>
      _$PopupAdsEntityListSystemDataFileFromJson(json);
}
