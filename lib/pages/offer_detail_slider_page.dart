          ...
          body: Padding(
            ...
            child:
              ...
              Expanded(
                ...
                onPageChanged: (index) {
                  currentPage = index;
                  BlocProvider.of<OfferBloc>(context).refresh(
                      list[currentPage].likes, list[currentPage].viewsCount);
                  setState(() {});
                      ...
                      children: [
                          ...
                          child: ClipRRect(
                              ...
                              child: FadeInImage.assetNetwork(
                                  ...
                                  image: APIConstants.getFullImageUrl(
                                      list[currentPage].systemDataFile1 != null
                                          ? list[currentPage]
                                              .systemDataFile1
                                              .url
                                          : "",
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                list[currentPage].description == null
                                    ? ""
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  InkWell(
                                      onTap: () async {
                                        var whatsappUrl =
                                            "whatsapp://send?phone=${list[currentPage].phoneNumber}";
                                  ...
                                  InkWell(
                                      onTap: () async {
                                        var url =
                                            list[currentPage].instagramLink;
                                        if (await canLaunch(url))
                                          await launch(url);
                                        else
                                          // can't launch url, there is some error
    ...
    return StreamBuilder<Counter>(
      ...
      builder: (context, snapshot) {
        ...
        return Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
          ...
          Text(viewCounter.count.toString(),
              style: TextStyle(
                color: AppColors.accentColor,
              )),
        ]);
