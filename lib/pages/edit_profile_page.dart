  ...
  Widget _buildProfile( ){
          ...
          child: Center(
           ...
           builder: (context, snapshot) {
             ...
             controller: firstController,
                 onChanged: BlocProvider.of<ProfileBloc>(context).changeFirstName,
                ...
                builder: (context, snapshot) {
                  ...
                  controller: phoneContorller,
                      onChanged: BlocProvider.of<ProfileBloc>(context).changeEmail,
                      style: TextStyle(fontSize: 22.0,
                          color: Color(0xFFbdc6cf),
                          decoration: TextDecoration.none),
                      decoration: InputDecoration(
    ...
    builder: (context, snapshot) {
          return GestureDetector(
            onTap: (){
              BlocProvider.of<ProfileBloc>(context).changeFirstName(firstController.text);
              BlocProvider.of<ProfileBloc>(context).changeEmail(phoneContorller.text);
